...
public class CaseServiceImpl extends ServiceImpl<CaseInfoMapper, CaseInfo> implements ICaseService {
     ...
     */
    @Override
    public P2CardActionTriggerResponse handleStrategyAnalysisConfirm(Map<String, Object> formData, String operatorId) {
        P2CardActionTriggerResponse resp = new P2CardActionTriggerResponse();
        CallBackToast toast = new CallBackToast();
        ...
        try {
            ...
            try {
                ...
                // 获取原卡片ID并更新
                String cardId = null;
                if (formData.containsKey("card_id")) {
                    // cardId = String.valueOf(formData.get("card_id"));
